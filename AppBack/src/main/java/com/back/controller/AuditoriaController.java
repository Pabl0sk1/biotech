...
public class AuditoriaController {
	...
	public Map<String, Object> listar(
		...
		var data = serv.query(Auditoria.class, page, size, order, filter, detail);
	...
	public Map<String, Object> guardar(@RequestBody Auditoria auditoria) {
		...
		result.put("saved", serv.guardar(auditoria));
	...
	public Map<String, Object> modificar(@PathVariable Integer id, @RequestBody Auditoria auditoria) {
		...
		Auditoria exist = serv.buscarPorId(id);

		if (exist != null) {
			auditoria.setId(id);
			result.put("updated", serv.guardar(auditoria));
		} else {
