...
import com.back.service.ProductoService;
...
public class ProductoController {
	...
	public Map<String, Object> listar(
		...
		var data = serv.query(Producto.class, page, size, order, filter, detail);
	...
	public Map<String, Object> guardar(@RequestBody Producto producto) {
		Map<String, Object> result = new LinkedHashMap<>();
		
		result.put("saved", serv.guardar(producto));
		
		return result;
	}

	@PutMapping(path = "update/{id}")
	public Map<String, Object> modificar(@PathVariable Integer id, @RequestBody Producto producto) {
		Map<String, Object> result = new LinkedHashMap<>();
		
		Producto exist = serv.buscarPorId(id);

		if (exist != null) {
			producto.setId(id);
			result.put("updated", serv.guardar(producto));
		} else {
