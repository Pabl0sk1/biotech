...
import com.back.service.TipoUsuarioService;
...
public class TipoUsuarioController {
	...
	public Map<String, Object> listar(
		...
		var data = serv.query(TipoUsuario.class, page, size, order, filter, detail);
	...
	public Map<String, Object> guardar(@RequestBody TipoUsuario tipousuario) {
		...
		result.put("saved", serv.guardar(tipousuario));
	...
	public Map<String, Object> modificar(@PathVariable Integer id, @RequestBody TipoUsuario tipousuario) {
		...
		TipoUsuario exist = serv.buscarPorId(id);

		if (exist != null) {
			tipousuario.setId(id);
			result.put("updated", serv.guardar(tipousuario));
		} else {
