...
public class TipoTurnoController {
	...
	public Map<String, Object> listar(
		...
		var data = serv.query(TipoTurno.class, page, size, order, filter, detail);
	...
	public Map<String, Object> guardar(@RequestBody TipoTurno tipoturno) {
		Map<String, Object> result = new LinkedHashMap<>();
		
		result.put("saved", serv.guardar(tipoturno));
		
		return result;
	}

	@PutMapping(path = "update/{id}")
	public Map<String, Object> modificar(@PathVariable Integer id, @RequestBody TipoTurno tipoturno) {
		Map<String, Object> result = new LinkedHashMap<>();
		
		TipoTurno exist = serv.buscarPorId(id);

		if (exist != null) {
			tipoturno.setId(id);
			result.put("updated", serv.guardar(tipoturno));
		} else {
