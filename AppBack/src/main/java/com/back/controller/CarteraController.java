...
import com.back.service.CarteraService;
...
public class CarteraController {
	...
	public Map<String, Object> listar(
		...
		var data = serv.query(Cartera.class, page, size, order, filter, detail);
	...
	public Map<String, Object> guardar(@RequestBody Cartera cartera) {
		Map<String, Object> result = new LinkedHashMap<>();
		
		result.put("saved", serv.guardar(cartera));
		
		return result;
	}

	@PutMapping(path = "update/{id}")
	public Map<String, Object> modificar(@PathVariable Integer id, @RequestBody Cartera cartera) {
		Map<String, Object> result = new LinkedHashMap<>();
		
		Cartera exist = serv.buscarPorId(id);

		if (exist != null) {
			cartera.setId(id);
			result.put("updated", serv.guardar(cartera));
		} else {
